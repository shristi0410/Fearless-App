...
import com.example.mayank.oneplussafety.MyBroadcastReceiver;
import com.example.mayank.oneplussafety.GPSTracker;
import com.example.mayank.oneplussafety.SessionManager;
...
public class MainActivity extends AppCompatActivity  implements GoogleApiClient.ConnectionCallbacks,
    ...
    private LinearLayout alarm, profile, fake_call;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fake_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, CallBReciever.class);
